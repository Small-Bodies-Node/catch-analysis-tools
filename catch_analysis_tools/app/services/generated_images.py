...
def _get_aws_client_kwargs(region):
    kwargs = {}
    region = region or os.environ.get("AWS_DEFAULT_REGION") or os.environ.get("TF_VAR_AWS_REGION") or "us-east-1"
    if region:
        kwargs["region_name"] = region

    access_key_id = os.environ.get("AWS_ACCESS_KEY_ID") or os.environ.get("TF_VAR_AWS_ACCESS_KEY_ID")
    secret_access_key = os.environ.get("AWS_SECRET_ACCESS_KEY") or os.environ.get("TF_VAR_AWS_SECRET_ACCESS_KEY")
    session_token = os.environ.get("AWS_SESSION_TOKEN") or os.environ.get("TF_VAR_AWS_SESSION_TOKEN")
